...
class EstadosEspecies2Controller extends \BaseController 
{
	...
	{
		$estadosEspecies2 = $this->servicioOMMFCM->getEstadosEspecies2();	

		return Response::json(array(
			'error' => false,
			'estadosEspecies' => $estadosEspecies2 -> toArray()),
			200
		);
	}
