...
describe('controlador incidentes', function(){
    ...
    it('obtiene todas las especies', function(){
        ...
        $timeout.flush();
        expect($scope.especies.length).not.toBe(0);
    });
    ...
    it('actualiza la pagina', function(){
        ...
        $timeout.flush();
        expect($scope.incidentes.length).not.toBe(0);
    ...
    it('muestra mensaje de exito cuando se elimina un incidente', function(){
        cambiarExito(true);
        $scope.eliminarIncidente(2);
        expect(mockServicioIncidentes.eliminarIncidente).toHaveBeenCalledWith(2);
        $timeout.flush();
    ...
    it('muestra mensaje de éxito cuando se modifica un incidente', function(){
        cambiarExito(true);
        $scope.modificarIncidente(15, 2);
        expect(mockServicioIncidentes.modificarIncidente).toHaveBeenCalledWith(15, 2);
        $timeout.flush();
